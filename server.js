...
mongoose.connect(`mongodb+srv://${username}:${password}@cluster0.joedd.mongodb.net/registrationFormDB`,{
...
/*mode of registation schema*/
const Registation = mongoose.model("Registration",registrationSchema);
app.use(bodyParser.urlencoded({extended: true}));
app.use(bodyParser.json());

app.get("/",(req,res)=> {
    res.sendFile(__dirname +"/registration form/index.html");
})
